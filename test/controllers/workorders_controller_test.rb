...
class WorkordersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workorder" do
    assert_difference('Workorder.count') do
      post workorders_url, params: { workorder: { coil_size: @workorder.coil_size, coils_delivered: @workorder.coils_delivered, date: @workorder.date, number_of_coils: @workorder.number_of_coils, weight: @workorder.weight, workorder_number: @workorder.workorder_number } }
    end
  ...
  test "should update workorder" do
    patch workorder_url(@workorder), params: { workorder: { coil_size: @workorder.coil_size, coils_delivered: @workorder.coils_delivered, date: @workorder.date, number_of_coils: @workorder.number_of_coils, weight: @workorder.weight, workorder_number: @workorder.workorder_number } }
